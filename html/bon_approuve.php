...
<div class="container-fluid">
    ...
    <div id="popup1" class="popup">
        ...
        <form class=""d-flex justify-content-center align-items-center" action="controllers/ticket_controler.php" method="post">
            <input type="text" name="ref" id="ref2" hidden>
            <button type="submit" class="btn btn-success w-100 fw-semibold" name="approuverer">Payer</button>
        </form>
